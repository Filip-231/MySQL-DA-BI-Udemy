...
select @s_var1; # w innym pliku na tym polaczeniu zadziala, natomiast w innym polaczeniu nie zadziala
...
create INDEX i_hire_date on employees(hire_date); # przyspiesza proces


select * from employees where first_name='Georgi' and last_name='Facello';
#composite index
create INDEX i_composite on employees(first_name, last_name); # przyspiesza proces
