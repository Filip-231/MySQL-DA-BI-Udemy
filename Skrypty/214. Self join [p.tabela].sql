...
#uzywamy self joinow jak kolumna ma odwolanie w tej samej tabeli?
SELECT #distinct daje 2 linijki wyniku #cos nie wychodzi bez warunku where ???
    e1.*
FROM
    emp_manager e1
        JOIN
